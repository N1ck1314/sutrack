...
trackers.extend(trackerlist(name='sutrack_active', parameter_name='sutrack_active_fix2_t224', dataset_name=dataset_name,
                            run_ids=None, display_name='sutrack_active_fix2_t224'))
