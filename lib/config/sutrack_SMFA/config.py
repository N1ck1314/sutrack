...
'''
SUTrack with SMFA (Self-Modulation Feature Aggregation)
'''
...
# SMFA Configuration
cfg.MODEL.ENCODER.USE_SMFA = True # Enable SMFA module
cfg.MODEL.ENCODER.SMFA_NUM_HEADS = 6 # Number of attention heads in EASA
cfg.MODEL.ENCODER.SMFA_MLP_RATIO = 4.0 # MLP expansion ratio in PCFN
