...
# STAtten相关配置
cfg.MODEL.ENCODER.USE_STATTEN = True # 是否启用STAtten注意力机制
cfg.MODEL.ENCODER.STATTEN_MODE = "STAtten" # 注意力模式：STAtten（时空注意力）或 SDT（脉冲驱动Transformer）
cfg.MODEL.ENCODER.USE_SNN = True # 是否使用脉冲神经网络（需要安装spikingjelly）
