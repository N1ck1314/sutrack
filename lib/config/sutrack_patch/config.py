...
'''
SUTrack Patch (Multi-scale Token Fusion Version)
This version includes multi-scale patch embeddings for scale-adaptive UAV tracking.
Key Feature: Adaptive multi-scale token fusion to handle scale variations.
'''
