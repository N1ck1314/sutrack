...
# SparseViT配置
cfg.MODEL.USE_SPARSEVIT = True  # 启用SparseViT模块
cfg.MODEL.SPARSEVIT_NUM_BLOCKS = 2  # SABlock数量
cfg.MODEL.SPARSEVIT_NUM_HEADS = 8  # 注意力头数
cfg.MODEL.SPARSEVIT_SPARSE_SIZES = [7, 7]  # 稀疏块大小（对于14x14的特征图）
