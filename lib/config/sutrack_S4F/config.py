...
# CMSA相关配置（sutrack_S4F默认启用CMSA改进多模态融合）
cfg.MODEL.ENCODER.USE_CMSA = True  # 是否启用CMSA模块（默认启用）
cfg.MODEL.ENCODER.CMSA_MODE = 'cmsa'  # CMSA融合模式: 'cmsa' 或 'concat'
cfg.MODEL.ENCODER.USE_SSM = True  # CMSA中是否使用SSM（选择性状态空间模型）
