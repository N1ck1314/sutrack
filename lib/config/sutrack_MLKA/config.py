...
'''
SUTrack with MLKA (Multi-scale Large Kernel Attention)
Improved multi-scale feature extraction for multi-modal tracking
'''
...
# MLKA Configuration
cfg.MODEL.USE_MLKA = True  # Enable MLKA enhancement
cfg.MODEL.MLKA_POSITION = "decoder"  # Where to apply MLKA: "encoder", "decoder", "both"
cfg.MODEL.MLKA_BLOCKS = 1  # Number of MLKA blocks (1-2 recommended)
