...
'''
SUTRACK_ARV2 (ARTrackV2 Integration)
This integrates ARTrackV2's core speedup strategies into SUTrack:
- Pure Encoder architecture (no intra-frame autoregression)
- Appearance Prompts for appearance evolution
- Oriented Masking for attention control
- Confidence Token for IoU prediction
'''
...
# MODEL.ARTRACKV2 - ARTrackV2 specific configurations
cfg.MODEL.ARTRACKV2 = edict()
cfg.MODEL.ARTRACKV2.ENABLE = True  # Enable ARTrackV2 modules
cfg.MODEL.ARTRACKV2.NUM_APPEARANCE_TOKENS = 4  # Number of appearance prompts
cfg.MODEL.ARTRACKV2.NUM_TRAJECTORY_TOKENS = 4  # x1, y1, x2, y2
cfg.MODEL.ARTRACKV2.ORIENTED_MASKING = True  # Enable oriented attention masking
cfg.MODEL.ARTRACKV2.APPEARANCE_RECON = True  # Enable appearance reconstruction
cfg.MODEL.ARTRACKV2.MASK_RATIO = 0.5  # Masking ratio for appearance reconstruction
cfg.MODEL.ARTRACKV2.CONFIDENCE_LOSS_WEIGHT = 0.5  # Weight for IoU prediction loss
cfg.MODEL.ARTRACKV2.APPEARANCE_RECON_LOSS_WEIGHT = 0.3  # Weight for appearance reconstruction loss
...
cfg.MODEL.ENCODER.TYPE = "fastitpnt" # encoder model - using tiny for faster speed
cfg.MODEL.ENCODER.DROP_PATH = 0
cfg.MODEL.ENCODER.PRETRAIN_TYPE = "pretrained/itpn/fast_itpn_tiny_clipl_e1600.pt" #
...
# TRAIN.ARTRACKV2 - ARTrackV2 specific training settings
cfg.TRAIN.ARTRACKV2 = edict()
cfg.TRAIN.ARTRACKV2.USE_REVERSE_AUGMENTATION = True  # Use reverse sequence augmentation
cfg.TRAIN.ARTRACKV2.REVERSE_PROB = 0.5  # Probability of reversing the sequence
cfg.TRAIN.ARTRACKV2.IOU_LOSS_WEIGHT = 0.5  # Weight for IoU regression loss
cfg.TRAIN.ARTRACKV2.APPEARANCE_RECON_LOSS_WEIGHT = 0.3  # Weight for appearance reconstruction loss
