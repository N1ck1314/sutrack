...
# DynRes配置
cfg.MODEL.USE_DYNRES = True  # 启用DynRes模块
cfg.MODEL.DYNRES_NUM_SCALES = 3  # 动态分辨率尺度数（低/中/高）
cfg.MODEL.DYNRES_NUM_VIEWS = 4  # 多视图数量
cfg.MODEL.DYNRES_USE_MULTI_VIEW = True  # 启用多视图融合
cfg.MODEL.DYNRES_USE_REGION_ALIGN = True  # 启用区域对齐
