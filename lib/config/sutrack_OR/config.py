...
'''
SUTrack with ORR (Occlusion-Robust Representations)
'''
...
# ORR Configuration (Occlusion-Robust Representations)
cfg.MODEL.ENCODER.USE_ORR = True # Enable ORR module
cfg.MODEL.ENCODER.ORR_MASK_RATIO = 0.3 # Ratio of patches to mask (0.3 = 30%)
cfg.MODEL.ENCODER.ORR_MASK_STRATEGY = 'cox' # Masking strategy: 'random', 'block', 'cox'
cfg.MODEL.ENCODER.ORR_LOSS_WEIGHT = 0.5 # Weight for feature invariance loss
