...
# SCSA specific configurations
cfg.MODEL.ENCODER.USE_SCSA = True  # Enable SCSA attention mechanism
cfg.MODEL.ENCODER.SCSA_REDUCTION_RATIO = 4  # Channel reduction ratio for PCSA
cfg.MODEL.ENCODER.SCSA_GATE_LAYER = 'sigmoid'  # Gate activation: 'sigmoid' or 'softmax'
