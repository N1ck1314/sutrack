...
'''
SUTrack Active (Modified Version)
This is the active/experimental version of SUTrack for modifications.
The original SUTrack model remains unchanged in lib/models/sutrack/
'''
...
# MODEL.FEATURE_ENHANCEMENT (for sutrack_activev1)
cfg.MODEL.USE_CROSS_ATTENTION = True
cfg.MODEL.USE_CBAM = True
cfg.MODEL.USE_TASK_ADAPTIVE = True

# MODEL.DEPTH_FUSION (for RGBD dynamic fusion)
cfg.MODEL.USE_DYNAMIC_DEPTH = True
cfg.MODEL.DEPTH_FUSION = edict()
cfg.MODEL.DEPTH_FUSION.TYPE = "adaptive"
cfg.MODEL.DEPTH_FUSION.TARGET_RATIO = 0.5
cfg.MODEL.DEPTH_FUSION.TEMPERATURE = 0.5
cfg.MODEL.DEPTH_FUSION.DEPTH_DIM_RATIO = 0.5

# MODEL.LAYERWISE_DEPTH
cfg.MODEL.LAYERWISE_DEPTH = edict()
cfg.MODEL.LAYERWISE_DEPTH.ENABLED = True
cfg.MODEL.LAYERWISE_DEPTH.LEARNABLE_GATES = True
...
cfg.TRAIN.DEPTH_EFFICIENCY_WEIGHT = 0.01
cfg.TRAIN.TARGET_DEPTH_RATIO = 0.5
