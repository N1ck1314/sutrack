...
def build_sutrack_patch(cfg):
    """
    Build SUTrack Patch (Multi-scale Token Fusion Version)
    This version includes multi-scale patch embeddings for scale-adaptive tracking.
    """
