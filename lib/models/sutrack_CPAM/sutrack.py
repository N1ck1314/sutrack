"""
SUTrack Model with CPAM
基于ASF-YOLO论文的通道和位置注意力增强版本

核心改进:
1. CPAM (Channel and Position Attention Mechanism): 联合通道+位置注意力
2. ChannelAttention: 筛选关键语义通道（"看什么"）
3. LocalAttention: 强化目标空间位置（"看哪里"）
"""
import torch
import math
...
class SUTRACK(nn.Module):
    """ This is the SUTrack with CPAM for channel and position attention enhancement """
    ...
    def forward_encoder(self, template_list, search_list, template_anno_list, text_src, task_index):
        # Forward the encoder (with CPAM enhancement)
