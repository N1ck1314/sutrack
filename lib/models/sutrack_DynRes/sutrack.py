"""
SUTrack Model with DynRes
基于DynRefer论文的动态分辨率增强版本
...
class SUTRACK(nn.Module):
    """ This is the SUTrack with DynRes for dynamic resolution enhancement """
    ...
    def forward_encoder(self, template_list, search_list, template_anno_list, text_src, task_index):
        # Forward the encoder (with DynRes enhancement)
