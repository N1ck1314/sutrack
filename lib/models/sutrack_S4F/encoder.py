"""
Encoder modules: we use ITPN for the encoder with CMSA support.
"""

from torch import nn
from lib.utils.misc import is_main_process
from lib.models.sutrack_S4F import fastitpn as fastitpn_module
from lib.models.sutrack_S4F import itpn as oriitpn_module
    ...
    def __init__(self, name: str,
        ...
        if "fastitpn" in name.lower():
            encoder = getattr(fastitpn_module, name)(
                ...
                # CMSA相关参数
                use_cmsa=cfg.MODEL.ENCODER.get('USE_CMSA', True),
