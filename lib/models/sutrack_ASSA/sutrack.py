"""
SUTrack Model with ASSA
基于AST论文的自适应稀疏注意力增强版本

核心改进:
1. ASSA (Adaptive Sparse Self-Attention): 双分支自适应稀疏注意力
...
class SUTRACK(nn.Module):
    """ This is the SUTrack with MFEblock for multi-scale feature enhancement """
    ...
    def forward_encoder(self, template_list, search_list, template_anno_list, text_src, task_index):
        # Forward the encoder (with MFEblock enhancement)
