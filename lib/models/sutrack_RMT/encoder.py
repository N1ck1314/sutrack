"""
Encoder modules: we use ITPN for the encoder with RMT support.
集成了RMT（Retentive Multi-scale Transformer）模块
"""

from torch import nn
from lib.utils.misc import is_main_process
from lib.models.sutrack_RMT import fastitpn as fastitpn_module
from lib.models.sutrack_RMT import itpn as oriitpn_module
    ...
    def __init__(self, name: str,
        ...
        if "fastitpn" in name.lower():
            encoder = getattr(fastitpn_module, name)(
                ...
                # RMT相关参数
                use_rmt=cfg.MODEL.ENCODER.get('USE_RMT', True),
                rmt_layers=cfg.MODEL.ENCODER.get('RMT_LAYERS', [8, 9, 10, 11]),
