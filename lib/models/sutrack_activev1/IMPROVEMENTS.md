# SUTrack Active V1 - 特征增强版本

## 版本说明

**sutrack_activev1** 是 sutrack_active 的改进版本，集成了 feature_enhancement.py 中的特征增强模块。

### 主要改进

1. ✅ **Cross-Attention 模块** - 增强 template-search 特征交互
2. ✅ **CBAM 注意力机制** - 通道和空间注意力增强
3. ✅ **Task Adaptive 模块** - 基于任务类型的特征适配
4. ✅ **配置化开关** - 通过 YAML 配置灵活控制模块启用

### 与 sutrack_active 的区别

| 特性 | sutrack_active | sutrack_activev1 |
|------|---------------|------------------|
| Cross-Attention | ❌ 未使用 | ✅ 已集成 |
| CBAM | ❌ 未使用 | ✅ 已集成 |
| Task Adaptive | ❌ 未使用 | ✅ 已集成 |
| 配置开关 | ❌ 无 | ✅ 有 |
| 动态激活 | ✅ 有 | ✅ 有（继承） |
